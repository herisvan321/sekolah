      ...
      <div class="col-md-12">
       <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Pengembalian Buku</h3>
            ...
            <div class="panel-body">
               <table id="example1" class="table table-bordered table-striped datatable">
                ...
                <tr>
                  ...
                  <td>1</td>
                  <td>
                    <a  class="btn btn-default" data-id="1" href='#myModal' class='btn btn-default btn-small' id='custId' data-toggle='modal'>click</a>
                  </td>
