      ...
      <div class="col-md-12">
       <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">History Peminjaman</h3>
            ...
            <div class="panel-body">
              <table id="example1" class="table table-bordered table-striped datatable">
                ...
                <tr>
                  ...
                  <td>nama siswa</td>
                  <td>1</td>
                  <td style="background: red; color:#fff;">dipinjam</td>
                  <td>
                    <a  class="btn btn-default" data-id="1" href='#myModal' class='btn btn-default btn-small' id='custId' data-toggle='modal'>Detail</a>
                  </td>
                ...
                <tr>
                  ...
                  <td>nama siswa</td>
                  <td>1</td>
                  <td style="background: blue; color:#fff;">dikembalikan</td>
                  <td>
                    <a  class="btn btn-default" data-id="1" href='#myModal' class='btn btn-default btn-small' id='custId' data-toggle='modal'>Detail</a>
                  </td>
                </tr>
		       ...
		       <div class="col-md-12">
		    	<div class="container-fluid">
		    		...
		    		<div class="col-md-12">
		    			...
		    			<input type="number" name="nis" class="form-control" placeholder="Enter Nis Siswa" required="required" readonly="">
		    		</div>
		    		<div class="col-md-12">
		    		...
		    		<div class="col-md-12">
		    			...
		    			<input type="number" name="jumlah pinjam" class="form-control" placeholder="Enter tgl Pinjam" required="required" readonly="readonly">
		    		</div>
